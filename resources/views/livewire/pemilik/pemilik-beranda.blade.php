            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body pb-0">
                        <div class="d-flex">
                            <div class="avatar">
                                <img src="{{ asset('assets/img/logoproduct.svg') }}" alt="dashboard."
                        ...
                        <div class="d-flex">
                            <div class="avatar">
                                <img src="{{ asset('assets/img/logoproduct3.svg') }}" alt="dashboard."
                                    class="avatar-img rounded-circle">
                            </div>
                            <div class="flex-1 pt-1 ml-2">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-list">
                            <div class="item-list">
                                <div class="avatar">
                                    <img src="{{ asset('assets/img/jm_denis.jpg') }}" alt="dashboard."
                                        class="avatar-img rounded-circle">
                                </div>
                            ...
                            <div class="item-list">
                                <div class="avatar">
                                    <img src="{{ asset('assets/img/chadengle.jpg') }}" alt="dashboard."
                                        class="avatar-img rounded-circle">
                                </div>
                                <div class="info-user ml-3">
                            ...
                            <div class="item-list">
                                <div class="avatar">
                                    <img src="{{ asset('assets/img/talha.jpg') }}" alt="dashboard."
                                        class="avatar-img rounded-circle">
                                </div>
                                <div class="info-user ml-3">
                            ...
                            <div class="item-list">
                                <div class="avatar">
                                    <img src="{{ asset('assets/img/mlane.jpg') }}" alt="dashboard."
                                        class="avatar-img rounded-circle">
                                </div>
                                <div class="info-user ml-3">
