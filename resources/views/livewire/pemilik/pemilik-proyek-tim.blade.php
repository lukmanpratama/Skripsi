        ...
        <div class="page-header">
            ...
            <ul class="breadcrumbs">
                <ul class="nav nav-line nav-color-secondary">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="/pemilik/proyek/{{ $timproyek->id }}" wire:navigate>Detil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="/pemilik/proyek/*/tim" wire:navigate>Tim</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/pemilik/proyek/{{ $timproyek->id }}/tugas" wire:navigate>Tugas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/pemilik/proyek/{{ $timproyek->id }}/waktu" wire:navigate>Waktu</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/pemilik/proyek/{{ $timproyek->id }}/biaya" wire:navigate>Biaya</a>
                    </li>
