        ...
        <div class="page-header">
            ...
            <ul class="breadcrumbs">
                <ul class="nav nav-line nav-color-secondary">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/admin/proyek" wire:navigate>Proyek</a>
                    </li>
                </ul>
            </ul>
        </div>
                                ...
                                <tbody>
                                    @foreach ($proyeks as $proyek)
                                        <tr wire:key="{{ $proyek->id }}">
                                            ...
                                            <td>
                                                <a href="/admin/proyek/{{ $proyek->id }}" wire:navigate
                                                    class="badge badge-info"
                                                    title="Detil Proyek, Tugas, Aktivitas">+</a>
                                                <a href="/admin/proyek/{{ $proyek->id }}"
                                                    title="Detil Proyek, Tugas, Aktivitas"
                                                    wire:navigate>{{ $proyek->nama_proyek }}</a>

                                            </td>
                                            <td>
                                                <a href="/admin/proyek/{{ $proyek->id }}/tim" wire:navigate
