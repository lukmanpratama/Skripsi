        ...
        <div class="page-header">
            ...
            <ul class="breadcrumbs">
                <ul class="nav nav-line nav-color-secondary">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/admin/proyek/*" wire:navigate>Detil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $detilproyek->id }}/tim" wire:navigate>Tim</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $detilproyek->id }}/tugas" wire:navigate>Tugas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $detilproyek->id }}/waktu" wire:navigate>Waktu</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $detilproyek->id }}/biaya" wire:navigate>Biaya</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $detilproyek->id }}/estimasi" wire:navigate>Estimasi</a>
                    </li>
                    <li class="nav-item">
