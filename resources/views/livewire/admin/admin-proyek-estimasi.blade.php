        ...
        <div class="page-header">
            ...
            <ul class="breadcrumbs">
                <ul class="nav nav-line nav-color-secondary">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $estimasiproyek->id }}" wire:navigate>Detil Proyek</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $estimasiproyek->id }}/tim" wire:navigate>Tim</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $estimasiproyek->id }}/tugas" wire:navigate>Tugas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $estimasiproyek->id }}/waktu" wire:navigate>Waktu</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $estimasiproyek->id }}/biaya" wire:navigate>Biaya</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  active" href="/admin/proyek/*/estimasi" wire:navigate>Estimasi</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="add-row" class="display table table-striped table-hover">
                                ...
                                <tbody>
                                    @foreach ($estimasis as $estimasi)
                                        <tr wire:key="{{ $estimasi->id }}">
                                            <td>{{ $loop->index + $estimasis->firstItem() }}</a></td>
                                            <td>{{ $estimasi->tugas->nama_tugas }}</a></td>
                                            <td>{{ $estimasi->tugas->kode}}</td>
                                            <td>{{ $estimasi->predecessor }}</td>
                                            <td>{{ $estimasi->ES }}</td>
                                            <td>{{ $estimasi->EF }}</td>
                                            <td>{{ $estimasi->LS }}</td>
                                            <td>{{ $estimasi->LF }}</td>
                                            <td>{{ $estimasi->created_at->format('d F, Y') }}</td>
                                            <td>
                                                <div class="form-button-action">
                                                    <button wire:click="edit({{ $estimasi->id }})" type="button"
                            ...
                            <x-app.pagination :items="$estimasis" />
                        </div>
                    </div>
                </div>
            </div>
