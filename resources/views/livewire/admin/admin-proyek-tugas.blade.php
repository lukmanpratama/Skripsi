        ...
        <div class="page-header">
            ...
            <ul class="breadcrumbs">
                <ul class="nav nav-line nav-color-secondary">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $tugasproyek->id }}" wire:navigate>Detil</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $tugasproyek->id }}/tim" wire:navigate>Tim</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="/admin/proyek/*/tugas" wire:navigate>Tugas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $tugasproyek->id }}/waktu" wire:navigate>Waktu</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $tugasproyek->id }}/biaya" wire:navigate>Biaya</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/proyek/{{ $tugasproyek->id }}/estimasi" wire:navigate>Estimasi</a>
                    </li>
                </ul>
            </ul>
        </div>
                                            ...
                                            <form wire:submit.prevent="{{ $tugasId ? 'update' : 'store' }}">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="title">Kode Tugas</label>
                                                            <input type="text" wire:model="kode_tugas"
                                                                class="form-control" id="nama_tugas"
                                                                placeholder="Enter post title">
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <label for="title">Tahapan Tugas</label>
                                                                ...
                                                                <select wire:model="tahapan_tugas" class="form-control">
                                                                    <option value="" selected>Pilih Tahapan Tugas
                                                                    </option>
                                ...
                                <tbody>
                                    @foreach ($tugass as $tugas)
                                        <tr wire:key="{{ $tugas->id }}">
                                            ...
                                            <td>
                                                <a href="/admin/proyek/{{ $tugas->proyek_id }}/tugas/{{ $tugas->id }}/aktivitas" wire:navigate
